...
set terminal png font "Helvetica,10" size 500,200
set output "vf-man.png"
...
set title "Vodafone - Manchester WLZ versus Region on 4G\nUE near Cambridge"

az="< fgrep -- '-az' vf_man.csv"
wlz="< fgrep -- '-wlz' vf_man.csv"
